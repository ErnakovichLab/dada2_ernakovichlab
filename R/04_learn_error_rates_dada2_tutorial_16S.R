...
#' In this step we will learn the error rates for the sequencing run. Typically dada2 expects you to have data that has HiSeq or MiSeq-style quality scores, that is quality scores that range from 0-40. However, NovaSeq uses a technique called "binned" quality scores. This means that as quality scores are calculated from the sequencer, instead of assigning them a number between 0 and 40, they are instead assigned to 4 different quality scores, typically 
#' 
#' 0-2 -> 2
#' 3-14 -> 11
#' 15-30 -> 25
...
#' Trial 4 from Jonalim's comment in [https://github.com/benjjneb/dada2/issues/1307](https://github.com/benjjneb/dada2/issues/1307)
